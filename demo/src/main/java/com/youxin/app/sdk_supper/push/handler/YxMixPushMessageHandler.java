package com.youxin.app.sdk_supper.push.handler;
...
import com.youxin.yxlib.util.log.LogUtil;

import java.util.ArrayList;
import java.util.Map;

public class YxMixPushMessageHandler implements MixPushMessageHandler {
    ...
    public boolean onNotificationClicked(Context context, Map<String, String> payload) {
        ...
        LogUtil.i(YxMixPushMessageHandler.class.getSimpleName(), "rev pushMessage payload " + payload);
    ...
    private ComponentName initLaunchComponent(Context context) {
        ...
        StatusBarNotificationConfig config = YXCache.getNotificationConfig();
...
//        Context context = YXApplication.getContext();
