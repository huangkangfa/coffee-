package com.youxin.yxlib.util.encrypt;

import android.text.TextUtils;

import com.youxin.yxlib.util.convert.ConvertUtil;
import com.youxin.yxlib.util.encode.EncodeUtils;
...
public class EncryptUtils {
    ...
    public static byte[] decryptHexStringDES(String data, byte[] key) {
        return decryptDES(ConvertUtil.hex2Bytes(data), key);
    }
    ...
    public static byte[] decryptHexString3DES(String data, byte[] key) {
        return decrypt3DES(ConvertUtil.hex2Bytes(data), key);
    }
    ...
    public static byte[] decryptHexStringAES(String data, byte[] key) {
        return decryptAES(ConvertUtil.hex2Bytes(data), key);
    }
